public class CPFValidacaoTeste {
    ...
    public static boolean validarCPF(String cpf) {
        // CPF precisa ter 11 números para ter a primeira validacao (essa validacao pode ser feita fora do servidor)
        if (cpf.length() != 11) {
            return false;
        }
    ...
    // INICIO 
        ...
        // Confere para nao deixar entrar string como CPF, mas essa verificação pode ser feita na pag de cadastro antes de
    ...
    // Cada um dos 9 numeros sao multiplicados por outros numa ordem decrescente, que comeca em 10 e termina em 2:
    // Aqui ocorre o calculo da multiplicacao pelo peso decrescente, o loop opera a troca dos pesos
